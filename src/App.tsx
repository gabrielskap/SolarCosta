...
export default function App() {
  ...
  return (
    <div className="h-screen h-dvh bg-[#f4f6fa] text-slate-800 flex flex-col font-sans antialiased overflow-hidden">
      {/* Mobile Top Header Navigation */}
      <header className="md:hidden bg-[#004276] text-white p-4 flex items-center justify-between border-b border-blue-900 z-30 shadow-md shrink-0">
      ...
      <div className="flex-1 flex overflow-hidden min-h-0">
        ...
        <div className="flex-1 flex flex-col overflow-hidden min-w-0 min-h-0">
          ...
          <header className="hidden md:flex items-center justify-between gap-3 bg-white border-b border-slate-200 px-6 py-2.5 shrink-0 z-20">
