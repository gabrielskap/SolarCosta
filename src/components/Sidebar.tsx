...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed md:static top-0 left-0 bottom-0 z-40 w-64 bg-[#004276] text-white flex flex-col transition-transform duration-300 ease-in-out shrink-0 h-full ${
